...
namespace UnityToolbarExtender {
	...
	public class CustomToolbarLeft {
		...
		static void OnToolbarGUI() {
			...
			if (GUILayout.Button(new GUIContent((Texture2D)AssetDatabase.LoadAssetAtPath("Assets/Plugins/CustomToolbar/Editor/Icons/LookDevSingle1@2x.png", typeof(Texture2D))), ToolbarStyles.commandButtonStyle)) {
