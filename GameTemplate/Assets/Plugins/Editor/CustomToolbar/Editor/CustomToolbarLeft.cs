...
namespace UnityToolbarExtender
{
	...
	public class CustomToolbarLeft {
		...
		static CustomToolbarLeft() {
			...
			reloadSceneBtn = new GUIContent((Texture2D)AssetDatabase.LoadAssetAtPath("Assets/Plugins/Editor/CustomToolbar/Editor/Icons/LookDevResetEnv@2x.png", typeof(Texture2D)), "Reload scene");

			startFromFirstSceneBtn = new GUIContent((Texture2D)AssetDatabase.LoadAssetAtPath("Assets/Plugins/Editor/CustomToolbar/Editor/Icons/LookDevSingle1@2x.png", typeof(Texture2D)), "Start from 1 scene");
		}
